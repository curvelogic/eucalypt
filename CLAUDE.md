...
- `doc/reference/agent-reference.md` — dense syntax reference, prelude functions, pipeline patterns, and common pitfalls (READ THIS FIRST)
- `doc/appendices/syntax-gotchas.md` — critical precedence and syntax traps
- `doc/appendices/cheat-sheet.md` — quick syntax and operator reference

For specific topics, also consult:
- `doc/guide/expressions-and-pipelines.md` — pipeline style and catenation
- `doc/guide/anaphora.md` — `_`, `•`, and string anaphora usage
- `doc/guide/functions-and-combinators.md` — function definition and partial application
- `doc/reference/prelude/` — full prelude reference by category
...
- **Read relevant documentation FIRST** - always check `doc/` directory before making assumptions about language syntax or behaviour (see "Writing Eucalypt Code" section above)
