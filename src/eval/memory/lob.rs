...
mod tests {
    ...
    fn test_efficient_size_for_medium_range() {
        ...
        assert_eq!(LargeObjectBlock::efficient_size_for(1024 * 1024), 1024 * 1024);
        ...
        assert_eq!(LargeObjectBlock::efficient_size_for(900 * 1024), 960 * 1024); // 15 * 64KB
    }
    ...
    fn test_efficient_size_for_large_range() {
        ...
        // Exact boundaries
        assert_eq!(LargeObjectBlock::efficient_size_for(1280 * 1024), 1280 * 1024);
        assert_eq!(LargeObjectBlock::efficient_size_for(2048 * 1024), 2048 * 1024);
        
        // Round up cases
        assert_eq!(LargeObjectBlock::efficient_size_for(1025 * 1024), 1280 * 1024);
        assert_eq!(LargeObjectBlock::efficient_size_for(1500 * 1024), 1536 * 1024);
    }
