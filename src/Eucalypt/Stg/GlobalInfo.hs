...
globalRegistry =
  ...
  , GlobalInfo "EMPTYSET" []
  , GlobalInfo "SETCONTAINS" [Strict, Strict]
  , GlobalInfo "SETADD" [Strict, Strict]
  , GlobalInfo "SETREMOVE" [Strict, Strict]
  , GlobalInfo "SETMEMBERS" [Strict]
  , GlobalInfo "EMPTYDICT" []
  , GlobalInfo "DICTCONTAINSKEY" [Strict, Strict]
  , GlobalInfo "DICTGET" [Strict, Strict]
  , GlobalInfo "DICTPUT" [Strict, Strict, Strict]
  , GlobalInfo "DICTDEL" [Strict, Strict]
  , GlobalInfo "DICTENTRIES" [Strict]
