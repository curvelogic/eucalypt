...
mod tests {
    ...
    use crate::syntax::parse::{parse_expr, parse_unit};
...
{:#?}",
    ...
    fn test_rowan_integration() {
        // Comprehensive integration test for AST parser functionality
        // Tests string patterns, block anaphora, and complex structures together

        let complex_code = r#"
        // Test file demonstrating key AST parser features
        ...
        println!("Testing comprehensive AST integration...");
        ...
        println!("✓ AST parser integration test passed!");
    }
...
//
// Parse results and parsing interface
//
...
impl<T> Parse<T> {
    ...
    pub fn syntax_node(&self) -> super::kind::SyntaxNode {
        super::kind::SyntaxNode::new_root(self.green_node.clone())
    }
...
impl<T: rowan::ast::AstNode<Language = super::kind::EucalyptLanguage>> Parse<T> {
    /// Forget the AstNode type disposition and focus purely on SyntaxNode
    pub fn to_syntax(self) -> Parse<super::kind::SyntaxNode> {
        Parse {
...
impl<T> Parse<T>
where
    T: rowan::ast::AstNode<Language = super::kind::EucalyptLanguage>,
    T: super::validate::Validatable,
{
...
pub fn parse_expr(text: &str) -> Parse<super::ast::Soup> {
...
pub fn parse_unit(text: &str) -> Parse<super::ast::Unit> {
